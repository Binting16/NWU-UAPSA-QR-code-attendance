...
⚠️ ANDROID ONLY, sorry IOS users :<
...
⚠️ Note: HTML version is still in development for further updates. I'm an independent developer and an architecture student with a lot of architectural plates (Ayawq mabagsak sa AD, pati sa majors fls) so please bear with me. 🧸
---
